...
| Ref | Document | Nature |
|---|---|---|
| CDC v1 | `docs/sources/CDC-v1_Plateforme_SOFICLEF.pdf` — *CDC-SOFICLEF-DRH-2026-001 v1.0* | Fixed onboarding portal for one person; 8 modules; AI agent with RAG; 4 one-week sprints |
...
reusable onboarding template attached to the *Directeur de Production* job (`EN-012-DRH`)
inside the *Direction de Production* organizational scope. Everything the prototype shows on
